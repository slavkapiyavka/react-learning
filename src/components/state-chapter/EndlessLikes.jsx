...
const EndlessLikes = () => {
  ...
  return (
    <>
      <p>{likesCount !== 1 ? `${likesCount} likes` : `${likesCount} like`}</p>
      <button onClick={onButtonClick} className='like'>
        <svg fill={likesCount > 0 ? 'red' : '#000000'} xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 96.294 96.294">
        <g>
